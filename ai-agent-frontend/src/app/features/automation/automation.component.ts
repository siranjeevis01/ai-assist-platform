...
@Component({
  ...
  styles: [`
    ...
    .mini-stat { display: flex; align-items: center; gap: 0.8rem; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 12px; padding: 1rem 1.5rem; }
    .mini-stat .material-icons { font-size: 24px; color: var(--primary-color); }
    .stat-num { display: block; color: var(--text-primary); font-size: 1.3rem; font-weight: 700; }
    ...
    .section-header .material-icons { color: var(--primary-color); }
    .section-header h3 { margin: 0; color: var(--text-primary); }
    .templates-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1rem; margin-bottom: 2rem; }
    .template-card { background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 14px; padding: 1.3rem; cursor: pointer; transition: all 0.3s; }
    .template-card:hover { border-color: var(--primary-color); transform: translateY(-3px); box-shadow: 0 8px 25px rgba(0,0,0,0.3); }
    ...
    .template-icon .material-icons { color: white; font-size: 22px; }
    .template-card h4 { margin: 0 0 0.3rem; color: var(--text-primary); font-size: 0.95rem; }
    .template-card p { margin: 0 0 0.5rem; color: var(--text-secondary); font-size: 0.8rem; line-height: 1.5; }
    .template-trigger { color: var(--primary-color); font-size: 0.75rem; font-weight: 500; }
    .rule-card { display: flex; align-items: center; justify-content: space-between; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 14px; padding: 1.2rem 1.5rem; margin-bottom: 0.8rem; transition: all 0.2s; }
    .rule-card:hover { border-color: var(--border-color); }
    .rule-card.inactive { opacity: 0.6; }
    .rule-left { display: flex; align-items: center; gap: 1rem; flex: 1; }
    .rule-icon { width: 42px; height: 42px; border-radius: 10px; background: var(--bg-hover); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .rule-icon.active { background: rgba(102,126,234,0.15); }
    .rule-icon .material-icons { font-size: 20px; color: var(--text-secondary); }
    .rule-icon.active .material-icons { color: var(--primary-color); }
    .rule-info h4 { margin: 0 0 0.3rem; color: var(--text-primary); font-size: 1rem; }
    .rule-meta { display: flex; align-items: center; gap: 0.8rem; flex-wrap: wrap; }
    .trigger-badge { background: rgba(102,126,234,0.1); color: var(--primary-color); padding: 0.15rem 0.6rem; border-radius: 6px; font-size: 0.75rem; font-weight: 500; }
    .runs-count { color: var(--text-secondary); font-size: 0.8rem; }
    .last-run { color: var(--text-secondary); font-size: 0.8rem; }
