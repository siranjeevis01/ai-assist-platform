...
namespace AiAgentBackend.Services.NLP
{
    ...
    public class NlpService : INlpService
    {
        ...
        private static readonly Dictionary<string, string> _typoCorrections = new()
        {
            ...
            { "tommorrow", "tomorrow" }, { "tmorow", "tomorrow" },
            { "todays", "today" }, { "toady", "today" }, { "tdy", "today" },
            { "yesturday", "yesterday" }, { "yestrday", "yesterday" },
            { "remindr", "reminder" }, { "remnder", "reminder" }, { "reminde", "reminder" },
            { "schedual", "schedule" }, { "scheduel", "schedule" }, { "schdule", "schedule" },
            { "scheudle", "schedule" }, { "shcedule", "schedule" },
            { "calender", "calendar" }, { "calandar", "calendar" }, { "callender", "calendar" },
            { "creat", "create" }, { "crete", "create" }, { "creeate", "create" },
            { "creaet", "create" }, { "craete", "create" },
            { "delet", "delete" }, { "dlete", "delete" }, { "dlt", "delete" },
            { "mesage", "message" }, { "messge", "message" }, { "msg", "message" },
            { "messgae", "message" }, { "messsage", "message" },
            { "evnt", "event" }, { "evnet", "event" }, { "evet", "event" },
            { "taks", "task" }, { "tsak", "task" }, { "tsk", "task" },
            { "taask", "task" }, { "tsks", "tasks" },
            { "emial", "email" }, { "eamil", "email" }, { "mail", "email" },
            { "emaiil", "email" }, { "emal", "email" },
            { "ntoification", "notification" }, { "notifcation", "notification" },
            { "notifiation", "notification" }, { "ntf", "notification" },
            { "snozze", "snooze" }, { "snoz", "snooze" }, { "snz", "snooze" },
            { "complte", "complete" }, { "complet", "complete" }, { "done", "complete" },
            { "compleet", "complete" }, { "cmplete", "complete" },
            { "meeding", "meeting" }, { "meetign", "meeting" }, { "meting", "meeting" },
            { "metting", "meeting" }, { "meetig", "meeting" },
            { "appointmnt", "appointment" }, { "apointment", "appointment" },
            { "appoinment", "appointment" }, { "appt", "appointment" },
            { "remind me", "remind" },
            ...
            { "lkst", "list" }, { "lsit", "list" }, { "lst", "list" },
            { "chekc", "check" }, { "chec", "check" }, { "chk", "check" },
            { "adn", "and" }, { "nad", "and" },
            { "wiht", "with" }, { "wtih", "with" },
            { "fro", "for" }, { "fr", "for" },
            { "thsi", "this" }, { "tihs", "this" },
            ...
            { "peolple", "people" }, { "poeple", "people" },
            { "projct", "project" }, { "porject", "project" },
            { "rpeort", "report" }, { "reprot", "report" },
            { "reivew", "review" }, { "reviwe", "review" },
            { "prsentation", "presentation" }, { "presentaton", "presentation" },
            { "cotract", "contract" }, { "contrct", "contract" },
            { "invite", "invite" }, { "invit", "invite" },
            { "cancle", "cancel" }, { "cncel", "cancel" },
            { "postphone", "postpone" }, { "postpne", "postpone" },
            { "confrence", "conference" }, { "confernce", "conference" },
            { "webnair", "webinar" }, { "webniar", "webinar" },
            { "clent", "client" }, { "cliient", "client" },
            { "custmer", "customer" }, { "cusotmer", "customer" },
            { "follwup", "follow-up" }, { "followup", "follow-up" },
            { "dailly", "daily" }, { "daly", "daily" },
            { "wekly", "weekly" }, { "weekley", "weekly" },
            { "mnthly", "monthly" }, { "monthy", "monthly" },
            { "pritority", "priority" }, { "priorty", "priority" },
            { "hiegh", "high" }, { "hihg", "high" },
            { "mdium", "medium" }, { "medum", "medium" },
            { "lw", "low" }, { "loow", "low" },
        };
